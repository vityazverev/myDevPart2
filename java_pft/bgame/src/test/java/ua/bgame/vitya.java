...
public class vitya {
    ...
    public void vitya() {
        ...
        wd.findElement(By.id("exampleInputName1")).sendKeys("Віктор");
        ...
        wd.findElement(By.id("citi")).sendKeys("Одеса");
        wd.findElement(By.id("exampleInputEmail1")).click();
        wd.findElement(By.id("exampleInputEmail1")).clear();
        wd.findElement(By.id("exampleInputEmail1")).sendKeys("vityazverev@gmail.com");
        wd.findElement(By.id("tel")).click();
        wd.findElement(By.id("tel")).clear();
        wd.findElement(By.id("tel")).sendKeys("+38 (093) 847-89-61");
