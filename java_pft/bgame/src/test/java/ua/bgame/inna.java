...
public class inna {
    ...
    public void inna() {
        ...
        wd.findElement(By.id("exampleInputName1")).sendKeys("Инна");
        wd.findElement(By.id("exampleInputName2")).click();
        wd.findElement(By.id("exampleInputName2")).clear();
        wd.findElement(By.id("exampleInputName2")).sendKeys("Зверева");
        wd.findElement(By.id("citi")).click();
        wd.findElement(By.id("citi")).clear();
        wd.findElement(By.id("citi")).sendKeys("Одесса");
        wd.findElement(By.id("exampleInputEmail1")).click();
        wd.findElement(By.id("exampleInputEmail1")).clear();
        wd.findElement(By.id("exampleInputEmail1")).sendKeys("maloman@ukr.net");
        wd.findElement(By.id("tel")).click();
        wd.findElement(By.id("tel")).clear();
        wd.findElement(By.id("tel")).sendKeys("+38 (067) 947-27-03");
        if (!wd.findElement(By.xpath("//form[@id='form']/div[6]/div/select//option[1]")).isSelected()) {
            wd.findElement(By.xpath("//form[@id='form']/div[6]/div/select//option[1]")).click();
        }
